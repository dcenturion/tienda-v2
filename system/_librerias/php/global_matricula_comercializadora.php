...
function enviar_mail($data, $vConex,$pagweb="") {
             ...
             $body='
                                ...
                                <div style="width:100%;display:flex">
                                    ...
                                    <div style="width:80%;text-align:center;font-size:1.3em;font-family: Arial;">
                                            ...
                                            <div style="width:100%;text-align:center;padding: 0% 35%;font-weight: bold;    padding-bottom: 2em;"><div style="background-color:#1578bc;color:white;width:300px;padding: .5em;width: 30%;"><a href="'.$pagweb.'" style="color: white;    text-decoration: none;">Ir a Mi cuenta</a></div></div>
                                    </div>
                                    <div style="width:10%;"></div>
                                </div>
    ...
    if ($TipoProducto == 'libro' || $TipoProducto =='revista') {
           ...
           try {
               $emailE = emailSES_comercializadora($n_a, $destinatario, $asunto, $body);
           } catch (Exception $e) {
