...
function enviar_mail_usuario2($emaill,$vConex,$contrasena,$Empresa){
	...
	inconveniente, contactarse con el soporte t&eacute;cnico.';
			...
			$SQLprograma="	select ar.titulo from almacen as al
							inner join articulos as ar on al.producto=ar.producto
							where al.AlmacenCod={$CodAlmacen}";
			$rg = fetch($SQLprograma);
            ...
            if($tipoEnvio == 'Predeterminado'){
                ...
                $Texto = 'Estimado(a) <span style="color:#35A9AD">'.$n_a.'</span>, usted fue inscrito correctamente al proyecto: <span style="color:#35A9AD">' . $tituloPrograma . '</span>';
                ...
                $body .= '<tr><td colspan="3" style="padding:8px 0px;font-size:22px;" >Inscripci&oacute;n Exitosa</td></tr>';
                
				$body .= '<tr><td colspan="3" style="padding:8px 10px;font-size:10px;" ></td></tr>';
                $body .= '<tr><td colspan="3" style="font-size:13px;"> '.$Texto.'</td></tr>';
                $body .= '<tr><td colspan="3" style="padding:8px 10px;font-size:10px;" ></td></tr>';
                
				$body .= '<tr><td colspan="3" style="padding:8px 0px;font-size:14px;" >Datos de Accesos :</td></tr>';
				$body .= '<tr><td colspan="3" style="padding:8px 0px;font-size:10px;" >Usuario: '.$emaill['correo'].' </td></tr>';
				$body .= '<tr><td colspan="3" style="padding:8px 0px;font-size:10px;" >Contraseña: pass123    </td></tr>';
