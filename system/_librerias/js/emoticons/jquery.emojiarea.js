...
(function($, window, document) {
	...
	EmojiArea.prototype.setupButton = function() {
		...
		} else if (this.options.button !== false && this.$editor.parent().find('.emoji-button').length === 0) {
	...
	EmojiArea.createIcon = function(emoji) {
		...
		return ' <i class="' + filename + '" alt="' + util.htmlEntities(emoji) + '" ></i>';
	};
	...
	EmojiMenu.prototype.load = function() {
		...
		this.$items.append('<div class="arrow"></div>');
	};
	...
	EmojiMenu.prototype.reposition = function() {
		...
		offset.top -= $button.outerHeight(true) + this.$menu.outerHeight(true);
		offset.left -= (this.$menu.outerWidth(true) - $button.outerWidth(true)) / 2;
